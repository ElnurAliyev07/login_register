...
class Login:
    ...
    def Register(self):
        ...
        btn2 = Button(frame_input2, text="Register", command=self.register, cursor='hand2', font=('times new roman', 15), fg = 'white', bg = 'orangered', bd = 0, width = 15, height=1)
        btn2.place(x = 90, y = 340)
    ...
    def appscreen(self):
        ...
        label1 = Label(Frame_login, text="Hi! Welcome to my page", font=('times new roman', 32, 'bold'), fg = "black", bg = 'white')
        label1.place(x = 375, y = 100)
        
        label2 = Label(Frame_login, text="My name is Elnur", font=("times new roman", 32, "bold"), fg = 'black', bg = 'white')
        label2.place(x = 235, y = 160)
        
        label3 = Label(Frame_login, text="Come on baby", font=("times new roman", 32, "bold"), fg = 'black', bg = 'white')
